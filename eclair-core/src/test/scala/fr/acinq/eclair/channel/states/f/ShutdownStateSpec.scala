...
class ShutdownStateSpec extends TestkitBaseClass with StateTestsHelperMethods {
  ...
  override def withFixture(test: OneArgTest) = {
    ...
    within(30 seconds) {
      ...
      val expiry1 = 400144
      val cmd1 = PaymentLifecycle.buildCommand(amount1, expiry1, h1, Hop(null, TestConstants.Bob.nodeParams.nodeId, 0L, 0L, null) :: Nil)._1.copy(commit = false)
      ...
      val expiry2 = 400144
      val cmd2 = PaymentLifecycle.buildCommand(amount2, expiry2, h2, Hop(null, TestConstants.Bob.nodeParams.nodeId, 0L, 0L, null) :: Nil)._1.copy(commit = false)
